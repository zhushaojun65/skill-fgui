...
| 组件结构 | references/component_structure.md | component 根节点、滚动属性、overflow、margin、mask、hitTest |
| 资源包 | references/resources.md | package.xml 资源声明、image 九宫格/tile、movieclip/jta、font/sound/atlas |
...
| 任务关键词 | 加载模块 |
|------------|----------|
| component 根节点、组件基本结构、size、extention、overflow、scroll、margin、mask、hitTest、滚动容器 | 注意事项 + 组件结构 |
...
| package.xml、资源声明、九宫格、scale9grid、tile、duplicatePadding、movieclip、jta、font、sound、atlas、swf | 注意事项 + 资源包 |
